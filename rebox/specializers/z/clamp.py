...
from rebox.specializers.generic.util import bit_list_to_int
...
if __name__== '__main__':
    clamper = PartialMulClamp()
    ordering = Ordering([clamper])
    print(ordering.generate(3, 10, ctypes.c_uint64))